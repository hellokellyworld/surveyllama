...
module.exports = function (webpackEnv) {
	...
	return {
		...
		entry: {
			index: [isEnvDevelopment && require.resolve("react-dev-utils/webpackHotDevClient"), paths.appIndexJs].filter(
				Boolean
			)

			// newslettersubscribe: [
			// 	isEnvDevelopment && require.resolve("react-dev-utils/webpackHotDevClient"),
			// 	paths.appNewsLetterSubscribeJS
			// ].filter(Boolean)
		},
		...
		plugins: [
			...
			// 		{
			// 			inject: true,
			// 			chunks: ["newslettersubscribe"],
			// 			template: paths.appNewsLetterSubscribeHtml,
			// 			filename: "NewsLetterSubscribe.html"
			// 		},
			// 		isEnvProduction
			// 			? {
			// 					minify: {
